...
import nbtool.gui.logviews.calibrate.image.ColorTable;
...
public class Calibrate implements MouseListener,
                                  MouseMotionListener,
                                  ...
                                  IncrementalSliderParent
{
    ...
    public boolean canGoForward() {
        return false; //tool.getDataManager().hasElementAfter();
    }

    public boolean canGoBackward() {
        return false; //tool.getDataManager().hasElementBefore();
    }
